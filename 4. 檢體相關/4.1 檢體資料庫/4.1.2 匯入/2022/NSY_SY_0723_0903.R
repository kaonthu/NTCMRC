...
out_20220723 <- f(20220723,75,"SY","P11",330,"C70",330,2004,30)
...
out_20220730 <- f(20220730,95,"SY","P11",405,"C70",405,2005,5)
...
out_20220813 <- f(20220813,106,"SY","P11",500,"C70",500,2005,100)
...
out_20220817 <- f(20220817,87,"SY","P11",606,"C70",606,2007,6)
...
out_20220820 <- f(20220820,119,"SY","P11",693,"C70",693,2007,93)
...
out_20220827 <- f(20220827,100,"SY","P11",812,"C70",812,2009,12)
...
out_20220903 <- f(20220903,102,"SY","P11",912,"C70",912,2010,12)
