...
out_20220917 <- f(20220917,87,"SY","P11",1014,"C70",1014,2011,14)
...
out_20220924 <- f(20220924,58,"SY","P11",1101,"C70",1101,2012,1)
...
out_20221001 <- f(20221001,67,"SY","P11",1159,"C70",1159,2012,59)
...
out_20221015 <- f(20221015,109,"SY","P11",1226,"C70",1226,2013,26)
...
out_20221022 <- f(20221022,106,"SY","P11",1335,"C70",1335,2014,35)
...
out_20221029 <- f(20221029,61,"SY","P11",1441,"C70",1441,2015,41)
...
out_20221105 <- f(20221105,53,"SY","P11",1502,"C70",1502,2016,2)
...
out_20221112 <- f(20221112,106,"SY","P11",1555,"C70",1555,2016,55)
...
out_20221119 <- f(20221119,122,"SY","P11",1661,"C70",1661,2017,61)
