...
WHERE Specimen = 'BC'
AND IN_time >= 20220910; #119+100+102

CREATE temporary table kao_practice_5.Total_speciem_2021_2022_BC as
SELECT * FROM kao_practice_5.Total_speciem_2022_0723_0817
WHERE Specimen = 'BC'
AND IN_time >= 20220910 ; #1761-81 + 329 = 2009;

/* DROP temporary table kao_practice_5.Total_speciem_2021_2022_BC; */

SELECT * FROM kao_practice_5.Total_speciem_2021_2022_BC;

SELECT a.C_Date,a.sid,a.IN_time,b.data_exam,b.P_dn
FROM kao_practice_5.Total_speciem_2021_2022_BC as a
...
/* DELETE FROM CMRC_DB_kaonthu.CMRC_Sample_info 
WHERE C_date > 20220418 and CMRC_id is NULL; */ 
