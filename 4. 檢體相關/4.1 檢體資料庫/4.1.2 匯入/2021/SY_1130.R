...
out <- data.frame(sid=out_20211130$S_number,P_number=out_20211130$P_number,
C_number=out_20211130$C_number,Box=out_20211130$Box,Site=out_20211130$Site,
ML = 0,Specimen ="SY",QC=out_20211130$QC,C_Date=out_20211130$S_number_a,
IN_time = 20211201,CMRC_Reserved=0,sup=0)
