...
BC_2023 <- f(20230305,2000,"BC","P12",1,"B00",1,21,1)

write.table(BC_2023,"D:/基隆長庚社區醫學科研究中心/CMRC社區資料庫/20220112檢體登記/112編碼對照表(進行中)/印貼紙/BC_2023.csv",sep=",")
