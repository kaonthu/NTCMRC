...
last_ml <-   rep(12.5,1000)

U_2022 <- f(20210305,1001,"P11",1,"C05",10001,1480,4)

write.table(U_2022,"D:/基隆長庚社區醫學科研究中心/CMRC社區資料庫/20220112檢體登記/111編碼對照表(進行中)/印貼紙/U_2022.csv",sep=",")
