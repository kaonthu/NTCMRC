...
mysqlconnection = dbConnect(MySQL(), dbname = "CMRC_DB_kaonthu",user = 'kaonthu', password = 'asd123',host = '192.168.1.41')
...
dbWriteTable(mysqlconnection,"new_CMRC_db_20963_Scale_desc_20220105_R",out,append=TRUE)
