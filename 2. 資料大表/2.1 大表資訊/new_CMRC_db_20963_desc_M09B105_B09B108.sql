...
WHERE P_dn in ('M09B105','M09B106','M09B107','M09B108');
...
CREATE TABLE kao_practice_6.CMRC_M09B105_B09B108 (
...
'D:/Leeyu/JupyterWorkplace/20211229_kaonthu_report/檢驗值匯入Mysql/M09B105_B09B108_report_檢驗值.csv'
INTO TABLE kao_practice_6.CMRC_M09B105_B09B108
...
INNER JOIN kao_practice_6.CMRC_M09B105_B09B108 as t2
ON t1.p_id = t2.`病歷號`
SET
...
WHERE t1.sid in ('M09B105','M09B106','M09B107','M09B108')
OR t1.sid regexp "^M10B";
...
SELECT sid, n_1, p_id, sex, birth, age, height_y, weight_y, waist_y, systolic_y, diastolic_y, heartbeat_y, arm_circumference, calf_circumference, Thigh_circumference, Glucose_AC_y, Triglyceride_y, HDL_C_y, WBCb, RBCb,
	...
	WHERE sid in ('M09B105','M09B106','M09B107','M09B108')
    OR sid regexp "^M10B"; 
