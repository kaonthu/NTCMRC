...
'D:/基隆長庚社區醫學科研究中心/CMRC社區資料庫/Li_Yu_Lee/總人次收案資訊/2022_匯入工作/CMRC_all_persontimes_20220418.csv'
INTO TABLE CMRC_DB_2022_import_work.CMRC_all_persontimes_20220110_kaonthu_20220310
CHARACTER SET utf8 FIELDS 
TERMINATED BY ','  
LINES TERMINATED BY '\n' 
IGNORE 1 LINES; #20976 + 91 +90 + 71 + 77
...
WHERE data_exam = 20220418 AND `New_CMRC_id` = "";


UPDATE CMRC_DB_2022_import_work.CMRC_all_persontimes_20220110_kaonthu_20220310 as a
SET a.location = "貢寮區",a.location2 = "福隆里",a.location3 = "福隆里2"
WHERE a.data_exam = 20220418;
