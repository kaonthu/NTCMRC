...
'D:/基隆長庚社區醫學科研究中心/CMRC社區資料庫/Li_Yu_Lee/總人次收案資訊/2022_匯入工作/CMRC_all_persontimes_20220312.csv'
...
WHERE data_exam = 20220312 AND `New_CMRC_id` = "";


UPDATE CMRC_DB_2022_import_work.CMRC_all_persontimes_20220110_kaonthu_20220310 as a
SET a.location = "貢寮區",a.location2 = "仁里里",a.location3 = "仁里里"
WHERE a.data_exam = 20220312;
