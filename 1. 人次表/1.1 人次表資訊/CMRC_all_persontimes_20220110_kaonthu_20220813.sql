...
'D:/基隆長庚社區醫學科研究中心/CMRC社區資料庫/Li_Yu_Lee/總人次收案資訊/2022_匯入工作/CMRC_all_persontimes_20220813.csv'
...
#20976 + 91 +90 + 71 + 77 +61 + 4 + 75 + 95 + 106
...
WHERE data_exam = 20220813 AND `New_CMRC_id` = "";
...
WHERE data_exam = 20220813 AND LENGTH(New_CMRC_id) = 13;
*/
#############################################################################
...
UPDATE CMRC_DB_2022_import_work.CMRC_all_persontimes_20220110_kaonthu_20220310 as a
SET a.location = "安樂區",a.location2 = "鶯歌里",a.location3 = "行政大樓"
WHERE a.data_exam = 20220813;
...
SELECT *
FROM CMRC_DB_2022_import_work.CMRC_all_persontimes_20220110_kaonthu_20220310
WHERE data_exam > 20220300; # 91+90+71+77+75+95+106
